...
int main() {
    ...
    if (UpdateManager::normalizeVersion("vV2.1.1") != "2.1.1") fail("version normalize repeated prefix");
    ...
    if (UpdateManager::isNewerVersion("2.1.4.1", "2.1.4")) fail("extra version component");
    if (UpdateManager::isNewerVersion("2.-1.5", "2.1.4")) fail("negative version component");
    if (UpdateManager::isNewerVersion("2147483648.1.5", "2.1.4")) fail("overflow version component");
